    ...
    <React.Fragment>
      <Toolbar className={classes.toolbar}>
        ...
        <Hidden smUp>
          ...
          <IconButton onClick={handleOpen} edge="end" color="inherit" aria-label="menu">
            <MenuIcon />
          </IconButton>
          <SwipeableDrawer anchor="right" open={open} onClose={handleClose} onOpen={handleOpen}>
            <Link to="/login" title="login" style={{ color: "inherit", textDecoration: "inherit", textAlign: "center" }}>
              <Button size="small"> { t('header.login') } </Button>
            </Link>
            <Link to="/register" title="register" style={{ color: "inherit", textDecoration: "inherit", textAlign: "center" }}>
