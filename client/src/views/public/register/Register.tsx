...
import LinkHref from "@material-ui/core/Link/Link";
					...
					<div className={classes.paper}>
						...
						<form className={classes.form}>
							...
							<FormControlLabel
								...
								label={
                                    <LinkHref  href="/info#terms_conditions" target="_blank" style={{textDecoration:"none"}}  color="primary">Acepto los terminos y condiciones</LinkHref>
                                }
							/>
							<Button
								fullWidth
