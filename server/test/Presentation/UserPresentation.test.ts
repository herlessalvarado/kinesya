...
describe("User Presentation Test",()=>{
    ...
    describe("create user",()=>{
        ...
        test("user create DTO with duplicate username and email",async ()=>{
            userService.create.mockImplementationOnce(()=>{
                throw new UserServiceException(["Duplicate email","Duplicate username"])
            });
        ...
        test("Internal Error raised",async ()=>{
            userService.create.mockImplementationOnce(()=>{
                throw new Error("Internal Error raised in Repository")
            });
