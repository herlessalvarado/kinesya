...
function userCredentials(serviceResult, userDB, password) {
    return __awaiter(this, void 0, void 0, function () {
        var isValidPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!userDB) return [3 /*break*/, 1];
                    serviceResult.addError(new Error("The email doesnt exists"));
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, bcryptjs_1.default.compare(password, userDB.password)];
                case 2:
